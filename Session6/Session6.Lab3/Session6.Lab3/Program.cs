...
class Program
{
    static void Main()
    {
        ...
        while (true)
        {
            Console.Write("A)dd C)Change D)elete L)ist pets:");
                ...
                case "c":
                    {
                        ...
                        var petNameNew = Console.ReadLine();
                        pets[indexToChange - 1].Name = petNameNew;

                        Console.Write("Enter the new type:");
                        var petTypeNew = Console.ReadLine();
                        pets[indexToChange - 1].TypeOfPet = petTypeNew;
